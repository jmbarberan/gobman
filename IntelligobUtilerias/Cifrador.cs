        ...
        public static class RijndaelSimple
        {
            ...
            public static string Encriptar(string textoQueEncriptaremos)
            {
                if (!String.IsNullOrWhiteSpace(textoQueEncriptaremos))
                    return Encriptar(textoQueEncriptaremos, "mUltIgOb@29_5", "s@jMbg", "MD5", 1, "@1B2c3D4e5F6g7H8", 128);
                else
                    return String.Empty;
            }
            /// <summary>
            ...
            public static string Desencriptar(string textoEncriptado)
            {
                if (!String.IsNullOrWhiteSpace(textoEncriptado))
                    return Desencriptar(textoEncriptado, "mUltIgOb@29_5", "s@jMbg", "MD5", 1, "@1B2c3D4e5F6g7H8", 128);
                else
                    return String.Empty;
            }
            /// <summary>
