...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// SeguimientosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ISeguimientosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<SeguimientoDto> ReadSeguimientos();
	    ...
	    [OperationContract]	
	    ItemInfo<SeguimientoDto> CreateSeguimiento(SeguimientoDto seguimiento);
	    ...
	    [OperationContract]
	    SeguimientoDto UpdateSeguimiento(string dtoKey, SeguimientoDto seguimiento);
	    ...
	    [OperationContract]    
	    void DeleteSeguimiento(string dtoKey);
	}
}
