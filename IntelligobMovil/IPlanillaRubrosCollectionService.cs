...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PlanillaRubrosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPlanillaRubrosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PlanillaRubroDto> ReadPlanillaRubros();
	    ...
	    [OperationContract]	
	    ItemInfo<PlanillaRubroDto> CreatePlanillaRubro(PlanillaRubroDto planillarubro);
	    ...
	    [OperationContract]
	    PlanillaRubroDto UpdatePlanillaRubro(string dtoKey, PlanillaRubroDto planillarubro);
	    ...
	    [OperationContract]    
	    void DeletePlanillaRubro(string dtoKey);
	}
}
