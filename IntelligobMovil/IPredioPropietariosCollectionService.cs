...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioPropietariosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioPropietariosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioPropietarioDto> ReadPredioPropietarios();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioPropietarioDto> CreatePredioPropietario(PredioPropietarioDto prediopropietario);
	    ...
	    [OperationContract]
	    PredioPropietarioDto UpdatePredioPropietario(string dtoKey, PredioPropietarioDto prediopropietario);
	    ...
	    [OperationContract]    
	    void DeletePredioPropietario(string dtoKey);
	}
}
