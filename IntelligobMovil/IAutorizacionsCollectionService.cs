...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// AutorizacionsCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IAutorizacionsCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<AutorizacionDto> ReadAutorizacions();
	    ...
	    [OperationContract]	
	    ItemInfo<AutorizacionDto> CreateAutorizacion(AutorizacionDto autorizacion);
	    ...
	    [OperationContract]
	    AutorizacionDto UpdateAutorizacion(string dtoKey, AutorizacionDto autorizacion);
	    ...
	    [OperationContract]    
	    void DeleteAutorizacion(string dtoKey);
	}
}
