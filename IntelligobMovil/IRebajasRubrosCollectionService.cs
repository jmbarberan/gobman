...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RebajasRubrosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRebajasRubrosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RebajasRubroDto> ReadRebajasRubros();
	    ...
	    [OperationContract]	
	    ItemInfo<RebajasRubroDto> CreateRebajasRubro(RebajasRubroDto rebajasrubro);
	    ...
	    [OperationContract]
	    RebajasRubroDto UpdateRebajasRubro(string dtoKey, RebajasRubroDto rebajasrubro);
	    ...
	    [OperationContract]    
	    void DeleteRebajasRubro(string dtoKey);
	}
}
