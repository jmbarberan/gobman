...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioTerrenosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioTerrenosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioTerrenoDto> ReadPredioTerrenos();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioTerrenoDto> CreatePredioTerreno(PredioTerrenoDto predioterreno);
	    ...
	    [OperationContract]
	    PredioTerrenoDto UpdatePredioTerreno(string dtoKey, PredioTerrenoDto predioterreno);
	    ...
	    [OperationContract]    
	    void DeletePredioTerreno(string dtoKey);
	}
}
