...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RepRecaudacionesCompDetallesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRepRecaudacionesCompDetallesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RepRecaudacionesCompDetalleDto> ReadRepRecaudacionesCompDetalles();
	    ...
	    [OperationContract]	
	    ItemInfo<RepRecaudacionesCompDetalleDto> CreateRepRecaudacionesCompDetalle(RepRecaudacionesCompDetalleDto reprecaudacionescompdetalle);
	    ...
	    [OperationContract]
	    RepRecaudacionesCompDetalleDto UpdateRepRecaudacionesCompDetalle(string dtoKey, RepRecaudacionesCompDetalleDto reprecaudacionescompdetalle);
	    ...
	    [OperationContract]    
	    void DeleteRepRecaudacionesCompDetalle(string dtoKey);
	}
}
