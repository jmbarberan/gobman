...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// PredioConstruccionsCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class PredioConstruccionsCollectionService : IPredioConstruccionsCollectionService
		{
			...
			#region IPredioConstruccionsCollectionService Members
			...
			{
				return this.HandleReadPredioConstruccion(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<PredioConstruccionDto> ReadPredioConstruccions()
			{
				return this.HandleReadPredioConstruccions(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="predioconstruccion">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<PredioConstruccionDto> CreatePredioConstruccion(PredioConstruccionDto predioconstruccion)
			{
				return this.HandleCreatePredioConstruccion(predioconstruccion, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="predioconstruccion">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public PredioConstruccionDto UpdatePredioConstruccion(string dtoKey, PredioConstruccionDto predioconstruccion)
			{
				return this.HandleUpdatePredioConstruccion(dtoKey, predioconstruccion);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeletePredioConstruccion(string dtoKey)
			{
				this.HandleDeletePredioConstruccion(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of PredioConstruccions returned per page.
			/// </summary>
			public int PredioConstruccionsPerPageCount
			{
				get 
				{ 
					return this.predioconstruccionsPerPageCount; 
				}
				set 
				{
					if (value != this.predioconstruccionsPerPageCount)
					{
						this.predioconstruccionsPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IPredioConstruccionService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new PredioConstruccionService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a predioconstruccion to the database and return the predioconstruccion with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="predioconstruccion">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected PredioConstruccionDto Create(PredioConstruccionDto predioconstruccion)
			{
				try
				{
					string dtoKey = this.Service.Add(predioconstruccion);
					this.UnitOfWork.SaveChanges();
					PredioConstruccionDto addedPredioConstruccion = this.Read(dtoKey);
					if (addedPredioConstruccion == null)
					{
					...
					return addedPredioConstruccion;
				}
			...
			/// <summary>
			/// Returns the PredioConstruccionDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PredioConstruccionDto Read(string dtoKey)
			{
				try
				{
					PredioConstruccionDto predioconstruccion = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, PredioConstruccionDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the predioconstruccion with the specified dto key in the database. 
			...
			/// <param name="predioconstruccion">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, PredioConstruccionDto predioconstruccion)
			{
				try
				{
					if (dtoKey != predioconstruccion.DtoKey && dtoKey != predioconstruccion.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(predioconstruccion);
			...
			/// <summary>
			/// Deletes the predioconstruccion with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					PredioConstruccionDto predioconstruccion = Read(dtoKey);
					if (predioconstruccion == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(predioconstruccion);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the predioconstruccion count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of predioconstruccion with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="predioconstruccion">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<PredioConstruccionDto> HandleCreatePredioConstruccion(PredioConstruccionDto predioconstruccion, UriTemplate template)
			{
				PredioConstruccionDto addedPredioConstruccion = this.Create(predioconstruccion);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedPredioConstruccion.DtoKey, template));
				ItemInfo<PredioConstruccionDto> itemInfo = new ItemInfo<PredioConstruccionDto>();
				itemInfo.Item = addedPredioConstruccion;
				itemInfo.EditLink = GetItemLink(addedPredioConstruccion.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of predioconstruccion with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PredioConstruccionDto HandleReadPredioConstruccion(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of PredioConstruccions with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<PredioConstruccionDto> HandleReadPredioConstruccions(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.PredioConstruccionsPerPageCount > maxEntities)
					{
						this.PredioConstruccionsPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.PredioConstruccionsPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.PredioConstruccionsPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, PredioConstruccionDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.PredioConstruccionsPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, PredioConstruccionDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<PredioConstruccionDto>> itemsInfo = new List<ItemInfo<PredioConstruccionDto>>();
	
					foreach (KeyValuePair<string, PredioConstruccionDto> item in items)
					{
						ItemInfo<PredioConstruccionDto> itemInfo = new ItemInfo<PredioConstruccionDto>();
					...
					return new ItemInfoList<PredioConstruccionDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of predioconstruccion with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="predioconstruccion">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected PredioConstruccionDto HandleUpdatePredioConstruccion(string dtoKey, PredioConstruccionDto predioconstruccion)
			{
				this.Update(dtoKey, predioconstruccion);
	
				return predioconstruccion;
			}
	
			/// <summary>
			/// Handles deleting of predioconstruccion with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeletePredioConstruccion(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// PredioConstruccionsCollectionService finalizer.
			/// </summary>
			~PredioConstruccionsCollectionService()
			{
