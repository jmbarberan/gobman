...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RepCuentaCorrienteResumensCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRepCuentaCorrienteResumensCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RepCuentaCorrienteResumenDto> ReadRepCuentaCorrienteResumens();
	    ...
	    [OperationContract]	
	    ItemInfo<RepCuentaCorrienteResumenDto> CreateRepCuentaCorrienteResumen(RepCuentaCorrienteResumenDto repcuentacorrienteresumen);
	    ...
	    [OperationContract]
	    RepCuentaCorrienteResumenDto UpdateRepCuentaCorrienteResumen(string dtoKey, RepCuentaCorrienteResumenDto repcuentacorrienteresumen);
	    ...
	    [OperationContract]    
	    void DeleteRepCuentaCorrienteResumen(string dtoKey);
	}
}
