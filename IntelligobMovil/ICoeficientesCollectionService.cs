...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CoeficientesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICoeficientesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CoeficienteDto> ReadCoeficientes();
	    ...
	    [OperationContract]	
	    ItemInfo<CoeficienteDto> CreateCoeficiente(CoeficienteDto coeficiente);
	    ...
	    [OperationContract]
	    CoeficienteDto UpdateCoeficiente(string dtoKey, CoeficienteDto coeficiente);
	    ...
	    [OperationContract]    
	    void DeleteCoeficiente(string dtoKey);
	}
}
