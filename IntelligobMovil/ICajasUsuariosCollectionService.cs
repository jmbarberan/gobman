...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CajasUsuariosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICajasUsuariosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CajasUsuarioDto> ReadCajasUsuarios();
	    ...
	    [OperationContract]	
	    ItemInfo<CajasUsuarioDto> CreateCajasUsuario(CajasUsuarioDto cajasusuario);
	    ...
	    [OperationContract]
	    CajasUsuarioDto UpdateCajasUsuario(string dtoKey, CajasUsuarioDto cajasusuario);
	    ...
	    [OperationContract]    
	    void DeleteCajasUsuario(string dtoKey);
	}
}
