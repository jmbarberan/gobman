...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RepCuentaCorrienteDetallesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRepCuentaCorrienteDetallesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RepCuentaCorrienteDetalleDto> ReadRepCuentaCorrienteDetalles();
	    ...
	    [OperationContract]	
	    ItemInfo<RepCuentaCorrienteDetalleDto> CreateRepCuentaCorrienteDetalle(RepCuentaCorrienteDetalleDto repcuentacorrientedetalle);
	    ...
	    [OperationContract]
	    RepCuentaCorrienteDetalleDto UpdateRepCuentaCorrienteDetalle(string dtoKey, RepCuentaCorrienteDetalleDto repcuentacorrientedetalle);
	    ...
	    [OperationContract]    
	    void DeleteRepCuentaCorrienteDetalle(string dtoKey);
	}
}
