...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RebajasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRebajasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RebajaDto> ReadRebajas();
	    ...
	    [OperationContract]	
	    ItemInfo<RebajaDto> CreateRebaja(RebajaDto rebaja);
	    ...
	    [OperationContract]
	    RebajaDto UpdateRebaja(string dtoKey, RebajaDto rebaja);
	    ...
	    [OperationContract]    
	    void DeleteRebaja(string dtoKey);
	}
}
