...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// SupervisionsCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ISupervisionsCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<SupervisionDto> ReadSupervisions();
	    ...
	    [OperationContract]	
	    ItemInfo<SupervisionDto> CreateSupervision(SupervisionDto supervision);
	    ...
	    [OperationContract]
	    SupervisionDto UpdateSupervision(string dtoKey, SupervisionDto supervision);
	    ...
	    [OperationContract]    
	    void DeleteSupervision(string dtoKey);
	}
}
