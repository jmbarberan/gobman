...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// ConveniosDividendosCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class ConveniosDividendosCollectionService : IConveniosDividendosCollectionService
		{
			...
			#region IConveniosDividendosCollectionService Members
			...
			{
				return this.HandleReadConveniosDividendo(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<ConveniosDividendoDto> ReadConveniosDividendos()
			{
				return this.HandleReadConveniosDividendos(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="conveniosdividendo">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<ConveniosDividendoDto> CreateConveniosDividendo(ConveniosDividendoDto conveniosdividendo)
			{
				return this.HandleCreateConveniosDividendo(conveniosdividendo, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="conveniosdividendo">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public ConveniosDividendoDto UpdateConveniosDividendo(string dtoKey, ConveniosDividendoDto conveniosdividendo)
			{
				return this.HandleUpdateConveniosDividendo(dtoKey, conveniosdividendo);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeleteConveniosDividendo(string dtoKey)
			{
				this.HandleDeleteConveniosDividendo(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of ConveniosDividendos returned per page.
			/// </summary>
			public int ConveniosDividendosPerPageCount
			{
				get 
				{ 
					return this.conveniosdividendosPerPageCount; 
				}
				set 
				{
					if (value != this.conveniosdividendosPerPageCount)
					{
						this.conveniosdividendosPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IConveniosDividendoService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new ConveniosDividendoService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a conveniosdividendo to the database and return the conveniosdividendo with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="conveniosdividendo">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected ConveniosDividendoDto Create(ConveniosDividendoDto conveniosdividendo)
			{
				try
				{
					string dtoKey = this.Service.Add(conveniosdividendo);
					this.UnitOfWork.SaveChanges();
					ConveniosDividendoDto addedConveniosDividendo = this.Read(dtoKey);
					if (addedConveniosDividendo == null)
					{
					...
					return addedConveniosDividendo;
				}
			...
			/// <summary>
			/// Returns the ConveniosDividendoDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected ConveniosDividendoDto Read(string dtoKey)
			{
				try
				{
					ConveniosDividendoDto conveniosdividendo = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, ConveniosDividendoDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the conveniosdividendo with the specified dto key in the database. 
			...
			/// <param name="conveniosdividendo">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, ConveniosDividendoDto conveniosdividendo)
			{
				try
				{
					if (dtoKey != conveniosdividendo.DtoKey && dtoKey != conveniosdividendo.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(conveniosdividendo);
			...
			/// <summary>
			/// Deletes the conveniosdividendo with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					ConveniosDividendoDto conveniosdividendo = Read(dtoKey);
					if (conveniosdividendo == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(conveniosdividendo);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the conveniosdividendo count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of conveniosdividendo with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="conveniosdividendo">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<ConveniosDividendoDto> HandleCreateConveniosDividendo(ConveniosDividendoDto conveniosdividendo, UriTemplate template)
			{
				ConveniosDividendoDto addedConveniosDividendo = this.Create(conveniosdividendo);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedConveniosDividendo.DtoKey, template));
				ItemInfo<ConveniosDividendoDto> itemInfo = new ItemInfo<ConveniosDividendoDto>();
				itemInfo.Item = addedConveniosDividendo;
				itemInfo.EditLink = GetItemLink(addedConveniosDividendo.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of conveniosdividendo with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected ConveniosDividendoDto HandleReadConveniosDividendo(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of ConveniosDividendos with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<ConveniosDividendoDto> HandleReadConveniosDividendos(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.ConveniosDividendosPerPageCount > maxEntities)
					{
						this.ConveniosDividendosPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.ConveniosDividendosPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.ConveniosDividendosPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, ConveniosDividendoDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.ConveniosDividendosPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, ConveniosDividendoDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<ConveniosDividendoDto>> itemsInfo = new List<ItemInfo<ConveniosDividendoDto>>();
	
					foreach (KeyValuePair<string, ConveniosDividendoDto> item in items)
					{
						ItemInfo<ConveniosDividendoDto> itemInfo = new ItemInfo<ConveniosDividendoDto>();
					...
					return new ItemInfoList<ConveniosDividendoDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of conveniosdividendo with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="conveniosdividendo">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected ConveniosDividendoDto HandleUpdateConveniosDividendo(string dtoKey, ConveniosDividendoDto conveniosdividendo)
			{
				this.Update(dtoKey, conveniosdividendo);
	
				return conveniosdividendo;
			}
	
			/// <summary>
			/// Handles deleting of conveniosdividendo with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeleteConveniosDividendo(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// ConveniosDividendosCollectionService finalizer.
			/// </summary>
			~ConveniosDividendosCollectionService()
			{
