...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CobrosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICobrosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CobroDto> ReadCobros();
	    ...
	    [OperationContract]	
	    ItemInfo<CobroDto> CreateCobro(CobroDto cobro);
	    ...
	    [OperationContract]
	    CobroDto UpdateCobro(string dtoKey, CobroDto cobro);
	    ...
	    [OperationContract]    
	    void DeleteCobro(string dtoKey);
	}
}
