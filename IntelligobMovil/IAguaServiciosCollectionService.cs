...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// AguaServiciosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IAguaServiciosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<AguaServicioDto> ReadAguaServicios();
	    ...
	    [OperationContract]	
	    ItemInfo<AguaServicioDto> CreateAguaServicio(AguaServicioDto aguaservicio);
	    ...
	    [OperationContract]
	    AguaServicioDto UpdateAguaServicio(string dtoKey, AguaServicioDto aguaservicio);
	    ...
	    [OperationContract]    
	    void DeleteAguaServicio(string dtoKey);
	}
}
