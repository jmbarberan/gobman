...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// SoporteMovimientosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ISoporteMovimientosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<SoporteMovimientoDto> ReadSoporteMovimientos();
	    ...
	    [OperationContract]	
	    ItemInfo<SoporteMovimientoDto> CreateSoporteMovimiento(SoporteMovimientoDto soportemovimiento);
	    ...
	    [OperationContract]
	    SoporteMovimientoDto UpdateSoporteMovimiento(string dtoKey, SoporteMovimientoDto soportemovimiento);
	    ...
	    [OperationContract]    
	    void DeleteSoporteMovimiento(string dtoKey);
	}
}
