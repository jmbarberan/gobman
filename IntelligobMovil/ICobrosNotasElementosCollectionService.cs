...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CobrosNotasElementosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICobrosNotasElementosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CobrosNotasElementoDto> ReadCobrosNotasElementos();
	    ...
	    [OperationContract]	
	    ItemInfo<CobrosNotasElementoDto> CreateCobrosNotasElemento(CobrosNotasElementoDto cobrosnotaselemento);
	    ...
	    [OperationContract]
	    CobrosNotasElementoDto UpdateCobrosNotasElemento(string dtoKey, CobrosNotasElementoDto cobrosnotaselemento);
	    ...
	    [OperationContract]    
	    void DeleteCobrosNotasElemento(string dtoKey);
	}
}
