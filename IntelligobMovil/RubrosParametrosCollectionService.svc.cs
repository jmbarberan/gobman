...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// RubrosParametrosCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class RubrosParametrosCollectionService : IRubrosParametrosCollectionService
		{
			...
			#region IRubrosParametrosCollectionService Members
			...
			{
				return this.HandleReadRubrosParametro(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<RubrosParametroDto> ReadRubrosParametros()
			{
				return this.HandleReadRubrosParametros(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="rubrosparametro">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<RubrosParametroDto> CreateRubrosParametro(RubrosParametroDto rubrosparametro)
			{
				return this.HandleCreateRubrosParametro(rubrosparametro, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="rubrosparametro">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public RubrosParametroDto UpdateRubrosParametro(string dtoKey, RubrosParametroDto rubrosparametro)
			{
				return this.HandleUpdateRubrosParametro(dtoKey, rubrosparametro);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeleteRubrosParametro(string dtoKey)
			{
				this.HandleDeleteRubrosParametro(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of RubrosParametros returned per page.
			/// </summary>
			public int RubrosParametrosPerPageCount
			{
				get 
				{ 
					return this.rubrosparametrosPerPageCount; 
				}
				set 
				{
					if (value != this.rubrosparametrosPerPageCount)
					{
						this.rubrosparametrosPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IRubrosParametroService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new RubrosParametroService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a rubrosparametro to the database and return the rubrosparametro with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="rubrosparametro">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected RubrosParametroDto Create(RubrosParametroDto rubrosparametro)
			{
				try
				{
					string dtoKey = this.Service.Add(rubrosparametro);
					this.UnitOfWork.SaveChanges();
					RubrosParametroDto addedRubrosParametro = this.Read(dtoKey);
					if (addedRubrosParametro == null)
					{
			...
			/// <summary>
			/// Returns the RubrosParametroDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected RubrosParametroDto Read(string dtoKey)
			{
				try
				{
					RubrosParametroDto rubrosparametro = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, RubrosParametroDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the rubrosparametro with the specified dto key in the database. 
			...
			/// <param name="rubrosparametro">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, RubrosParametroDto rubrosparametro)
			{
				try
				{
					if (dtoKey != rubrosparametro.DtoKey && dtoKey != rubrosparametro.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(rubrosparametro);
			...
			/// <summary>
			/// Deletes the rubrosparametro with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					RubrosParametroDto rubrosparametro = Read(dtoKey);
					if (rubrosparametro == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(rubrosparametro);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the rubrosparametro count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of rubrosparametro with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="rubrosparametro">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<RubrosParametroDto> HandleCreateRubrosParametro(RubrosParametroDto rubrosparametro, UriTemplate template)
			{
				RubrosParametroDto addedRubrosParametro = this.Create(rubrosparametro);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedRubrosParametro.DtoKey, template));
				ItemInfo<RubrosParametroDto> itemInfo = new ItemInfo<RubrosParametroDto>();
				itemInfo.Item = addedRubrosParametro;
				itemInfo.EditLink = GetItemLink(addedRubrosParametro.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of rubrosparametro with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected RubrosParametroDto HandleReadRubrosParametro(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of RubrosParametros with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<RubrosParametroDto> HandleReadRubrosParametros(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.RubrosParametrosPerPageCount > maxEntities)
					{
						this.RubrosParametrosPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.RubrosParametrosPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.RubrosParametrosPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, RubrosParametroDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.RubrosParametrosPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, RubrosParametroDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<RubrosParametroDto>> itemsInfo = new List<ItemInfo<RubrosParametroDto>>();
	
					foreach (KeyValuePair<string, RubrosParametroDto> item in items)
					{
						ItemInfo<RubrosParametroDto> itemInfo = new ItemInfo<RubrosParametroDto>();
					...
					return new ItemInfoList<RubrosParametroDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of rubrosparametro with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="rubrosparametro">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected RubrosParametroDto HandleUpdateRubrosParametro(string dtoKey, RubrosParametroDto rubrosparametro)
			{
				this.Update(dtoKey, rubrosparametro);
	
				return rubrosparametro;
			}
	
			/// <summary>
			/// Handles deleting of rubrosparametro with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeleteRubrosParametro(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// RubrosParametrosCollectionService finalizer.
			/// </summary>
			~RubrosParametrosCollectionService()
			{
