...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// PatentesComponentesCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class PatentesComponentesCollectionService : IPatentesComponentesCollectionService
		{
			...
			#region IPatentesComponentesCollectionService Members
			...
			{
				return this.HandleReadPatentesComponente(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<PatentesComponenteDto> ReadPatentesComponentes()
			{
				return this.HandleReadPatentesComponentes(itemUriTemplate);
			}
			...
			/// <returns></returns>
			public ItemInfo<PatentesComponenteDto> CreatePatentesComponente(PatentesComponenteDto patentescomponente)
			{
				return this.HandleCreatePatentesComponente(patentescomponente, itemUriTemplate);
			}
			...
			/// <returns></returns>
			public PatentesComponenteDto UpdatePatentesComponente(string dtoKey, PatentesComponenteDto patentescomponente)
			{
				return this.HandleUpdatePatentesComponente(dtoKey, patentescomponente);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeletePatentesComponente(string dtoKey)
			{
				this.HandleDeletePatentesComponente(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of PatentesComponentes returned per page.
			/// </summary>
			public int PatentesComponentesPerPageCount
			{
				get 
				{ 
					return this.patentescomponentesPerPageCount; 
				}
				set 
				{
					if (value != this.patentescomponentesPerPageCount)
					{
						this.patentescomponentesPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IPatentesComponenteService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new PatentesComponenteService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a patentescomponente to the database and return the patentescomponente with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="patentescomponente">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected PatentesComponenteDto Create(PatentesComponenteDto patentescomponente)
			{
				try
				{
					string dtoKey = this.Service.Add(patentescomponente);
					this.UnitOfWork.SaveChanges();
					PatentesComponenteDto addedPatentesComponente = this.Read(dtoKey);
					if (addedPatentesComponente == null)
					{
					...
					return addedPatentesComponente;
				}
			...
			/// <summary>
			/// Returns the PatentesComponenteDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PatentesComponenteDto Read(string dtoKey)
			{
				try
				{
					PatentesComponenteDto patentescomponente = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, PatentesComponenteDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the patentescomponente with the specified dto key in the database. 
			...
			/// <param name="patentescomponente">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, PatentesComponenteDto patentescomponente)
			{
				try
				{
					if (dtoKey != patentescomponente.DtoKey && dtoKey != patentescomponente.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(patentescomponente);
			...
			/// <summary>
			/// Deletes the patentescomponente with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					PatentesComponenteDto patentescomponente = Read(dtoKey);
					if (patentescomponente == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(patentescomponente);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the patentescomponente count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of patentescomponente with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="patentescomponente">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<PatentesComponenteDto> HandleCreatePatentesComponente(PatentesComponenteDto patentescomponente, UriTemplate template)
			{
				PatentesComponenteDto addedPatentesComponente = this.Create(patentescomponente);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedPatentesComponente.DtoKey, template));
				ItemInfo<PatentesComponenteDto> itemInfo = new ItemInfo<PatentesComponenteDto>();
				itemInfo.Item = addedPatentesComponente;
				itemInfo.EditLink = GetItemLink(addedPatentesComponente.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of patentescomponente with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PatentesComponenteDto HandleReadPatentesComponente(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of PatentesComponentes with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<PatentesComponenteDto> HandleReadPatentesComponentes(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.PatentesComponentesPerPageCount > maxEntities)
					{
						this.PatentesComponentesPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.PatentesComponentesPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.PatentesComponentesPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, PatentesComponenteDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.PatentesComponentesPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, PatentesComponenteDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<PatentesComponenteDto>> itemsInfo = new List<ItemInfo<PatentesComponenteDto>>();
	
					foreach (KeyValuePair<string, PatentesComponenteDto> item in items)
					{
						ItemInfo<PatentesComponenteDto> itemInfo = new ItemInfo<PatentesComponenteDto>();
					...
					return new ItemInfoList<PatentesComponenteDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of patentescomponente with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="patentescomponente">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected PatentesComponenteDto HandleUpdatePatentesComponente(string dtoKey, PatentesComponenteDto patentescomponente)
			{
				this.Update(dtoKey, patentescomponente);
	
				return patentescomponente;
			}
	
			/// <summary>
			/// Handles deleting of patentescomponente with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeletePatentesComponente(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// PatentesComponentesCollectionService finalizer.
			/// </summary>
			~PatentesComponentesCollectionService()
			{
