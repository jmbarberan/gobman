...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CajaComprobantesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICajaComprobantesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CajaComprobanteDto> ReadCajaComprobantes();
	    ...
	    [OperationContract]	
	    ItemInfo<CajaComprobanteDto> CreateCajaComprobante(CajaComprobanteDto cajacomprobante);
	    ...
	    [OperationContract]
	    CajaComprobanteDto UpdateCajaComprobante(string dtoKey, CajaComprobanteDto cajacomprobante);
	    ...
	    [OperationContract]    
	    void DeleteCajaComprobante(string dtoKey);
	}
}
