...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ContribuyentesRebajasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IContribuyentesRebajasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ContribuyentesRebajaDto> ReadContribuyentesRebajas();
	    ...
	    [OperationContract]	
	    ItemInfo<ContribuyentesRebajaDto> CreateContribuyentesRebaja(ContribuyentesRebajaDto contribuyentesrebaja);
	    ...
	    [OperationContract]
	    ContribuyentesRebajaDto UpdateContribuyentesRebaja(string dtoKey, ContribuyentesRebajaDto contribuyentesrebaja);
	    ...
	    [OperationContract]    
	    void DeleteContribuyentesRebaja(string dtoKey);
	}
}
