...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// MejorasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IMejorasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<MejoraDto> ReadMejoras();
	    ...
	    [OperationContract]	
	    ItemInfo<MejoraDto> CreateMejora(MejoraDto mejora);
	    ...
	    [OperationContract]
	    MejoraDto UpdateMejora(string dtoKey, MejoraDto mejora);
	    ...
	    [OperationContract]    
	    void DeleteMejora(string dtoKey);
	}
}
