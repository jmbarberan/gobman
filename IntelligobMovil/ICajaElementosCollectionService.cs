...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CajaElementosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICajaElementosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CajaElementoDto> ReadCajaElementos();
	    ...
	    [OperationContract]	
	    ItemInfo<CajaElementoDto> CreateCajaElemento(CajaElementoDto cajaelemento);
	    ...
	    [OperationContract]
	    CajaElementoDto UpdateCajaElemento(string dtoKey, CajaElementoDto cajaelemento);
	    ...
	    [OperationContract]    
	    void DeleteCajaElemento(string dtoKey);
	}
}
