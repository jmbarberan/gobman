...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// TablasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ITablasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<TablaDto> ReadTablas();
	    ...
	    [OperationContract]	
	    ItemInfo<TablaDto> CreateTabla(TablaDto tabla);
	    ...
	    [OperationContract]
	    TablaDto UpdateTabla(string dtoKey, TablaDto tabla);
	    ...
	    [OperationContract]    
	    void DeleteTabla(string dtoKey);
	}
}
