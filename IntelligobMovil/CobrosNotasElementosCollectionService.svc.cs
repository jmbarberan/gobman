...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// CobrosNotasElementosCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class CobrosNotasElementosCollectionService : ICobrosNotasElementosCollectionService
		{
			...
			#region ICobrosNotasElementosCollectionService Members
			...
			{
				return this.HandleReadCobrosNotasElemento(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<CobrosNotasElementoDto> ReadCobrosNotasElementos()
			{
				return this.HandleReadCobrosNotasElementos(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="cobrosnotaselemento">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<CobrosNotasElementoDto> CreateCobrosNotasElemento(CobrosNotasElementoDto cobrosnotaselemento)
			{
				return this.HandleCreateCobrosNotasElemento(cobrosnotaselemento, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="cobrosnotaselemento">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public CobrosNotasElementoDto UpdateCobrosNotasElemento(string dtoKey, CobrosNotasElementoDto cobrosnotaselemento)
			{
				return this.HandleUpdateCobrosNotasElemento(dtoKey, cobrosnotaselemento);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeleteCobrosNotasElemento(string dtoKey)
			{
				this.HandleDeleteCobrosNotasElemento(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of CobrosNotasElementos returned per page.
			/// </summary>
			public int CobrosNotasElementosPerPageCount
			{
				get 
				{ 
					return this.cobrosnotaselementosPerPageCount; 
				}
				set 
				{
					if (value != this.cobrosnotaselementosPerPageCount)
					{
						this.cobrosnotaselementosPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual ICobrosNotasElementoService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new CobrosNotasElementoService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a cobrosnotaselemento to the database and return the cobrosnotaselemento with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="cobrosnotaselemento">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected CobrosNotasElementoDto Create(CobrosNotasElementoDto cobrosnotaselemento)
			{
				try
				{
					string dtoKey = this.Service.Add(cobrosnotaselemento);
					this.UnitOfWork.SaveChanges();
					CobrosNotasElementoDto addedCobrosNotasElemento = this.Read(dtoKey);
					if (addedCobrosNotasElemento == null)
					{
					...
					return addedCobrosNotasElemento;
				}
			...
			/// <summary>
			/// Returns the CobrosNotasElementoDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected CobrosNotasElementoDto Read(string dtoKey)
			{
				try
				{
					CobrosNotasElementoDto cobrosnotaselemento = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, CobrosNotasElementoDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the cobrosnotaselemento with the specified dto key in the database. 
			...
			/// <param name="cobrosnotaselemento">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, CobrosNotasElementoDto cobrosnotaselemento)
			{
				try
				{
					if (dtoKey != cobrosnotaselemento.DtoKey && dtoKey != cobrosnotaselemento.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(cobrosnotaselemento);
			...
			/// <summary>
			/// Deletes the cobrosnotaselemento with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					CobrosNotasElementoDto cobrosnotaselemento = Read(dtoKey);
					if (cobrosnotaselemento == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(cobrosnotaselemento);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the cobrosnotaselemento count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of cobrosnotaselemento with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="cobrosnotaselemento">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<CobrosNotasElementoDto> HandleCreateCobrosNotasElemento(CobrosNotasElementoDto cobrosnotaselemento, UriTemplate template)
			{
				CobrosNotasElementoDto addedCobrosNotasElemento = this.Create(cobrosnotaselemento);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedCobrosNotasElemento.DtoKey, template));
				ItemInfo<CobrosNotasElementoDto> itemInfo = new ItemInfo<CobrosNotasElementoDto>();
				itemInfo.Item = addedCobrosNotasElemento;
				itemInfo.EditLink = GetItemLink(addedCobrosNotasElemento.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of cobrosnotaselemento with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected CobrosNotasElementoDto HandleReadCobrosNotasElemento(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of CobrosNotasElementos with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<CobrosNotasElementoDto> HandleReadCobrosNotasElementos(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.CobrosNotasElementosPerPageCount > maxEntities)
					{
						this.CobrosNotasElementosPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.CobrosNotasElementosPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.CobrosNotasElementosPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, CobrosNotasElementoDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.CobrosNotasElementosPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, CobrosNotasElementoDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<CobrosNotasElementoDto>> itemsInfo = new List<ItemInfo<CobrosNotasElementoDto>>();
	
					foreach (KeyValuePair<string, CobrosNotasElementoDto> item in items)
					{
						ItemInfo<CobrosNotasElementoDto> itemInfo = new ItemInfo<CobrosNotasElementoDto>();
					...
					return new ItemInfoList<CobrosNotasElementoDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of cobrosnotaselemento with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="cobrosnotaselemento">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected CobrosNotasElementoDto HandleUpdateCobrosNotasElemento(string dtoKey, CobrosNotasElementoDto cobrosnotaselemento)
			{
				this.Update(dtoKey, cobrosnotaselemento);
	
				return cobrosnotaselemento;
			}
	
			/// <summary>
			/// Handles deleting of cobrosnotaselemento with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeleteCobrosNotasElemento(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// CobrosNotasElementosCollectionService finalizer.
			/// </summary>
			~CobrosNotasElementosCollectionService()
			{
