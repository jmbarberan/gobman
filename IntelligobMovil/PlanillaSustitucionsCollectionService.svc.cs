...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// PlanillaSustitucionsCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class PlanillaSustitucionsCollectionService : IPlanillaSustitucionsCollectionService
		{
			...
			#region IPlanillaSustitucionsCollectionService Members
			...
			{
				return this.HandleReadPlanillaSustitucion(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<PlanillaSustitucionDto> ReadPlanillaSustitucions()
			{
				return this.HandleReadPlanillaSustitucions(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="planillasustitucion">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<PlanillaSustitucionDto> CreatePlanillaSustitucion(PlanillaSustitucionDto planillasustitucion)
			{
				return this.HandleCreatePlanillaSustitucion(planillasustitucion, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="planillasustitucion">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public PlanillaSustitucionDto UpdatePlanillaSustitucion(string dtoKey, PlanillaSustitucionDto planillasustitucion)
			{
				return this.HandleUpdatePlanillaSustitucion(dtoKey, planillasustitucion);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeletePlanillaSustitucion(string dtoKey)
			{
				this.HandleDeletePlanillaSustitucion(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of PlanillaSustitucions returned per page.
			/// </summary>
			public int PlanillaSustitucionsPerPageCount
			{
				get 
				{ 
					return this.planillasustitucionsPerPageCount; 
				}
				set 
				{
					if (value != this.planillasustitucionsPerPageCount)
					{
						this.planillasustitucionsPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IPlanillaSustitucionService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new PlanillaSustitucionService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a planillasustitucion to the database and return the planillasustitucion with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="planillasustitucion">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected PlanillaSustitucionDto Create(PlanillaSustitucionDto planillasustitucion)
			{
				try
				{
					string dtoKey = this.Service.Add(planillasustitucion);
					this.UnitOfWork.SaveChanges();
					PlanillaSustitucionDto addedPlanillaSustitucion = this.Read(dtoKey);
					if (addedPlanillaSustitucion == null)
					{
					...
					return addedPlanillaSustitucion;
				}
			...
			/// <summary>
			/// Returns the PlanillaSustitucionDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PlanillaSustitucionDto Read(string dtoKey)
			{
				try
				{
					PlanillaSustitucionDto planillasustitucion = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, PlanillaSustitucionDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the planillasustitucion with the specified dto key in the database. 
			...
			/// <param name="planillasustitucion">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, PlanillaSustitucionDto planillasustitucion)
			{
				try
				{
					if (dtoKey != planillasustitucion.DtoKey && dtoKey != planillasustitucion.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(planillasustitucion);
			...
			/// <summary>
			/// Deletes the planillasustitucion with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					PlanillaSustitucionDto planillasustitucion = Read(dtoKey);
					if (planillasustitucion == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(planillasustitucion);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the planillasustitucion count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of planillasustitucion with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="planillasustitucion">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<PlanillaSustitucionDto> HandleCreatePlanillaSustitucion(PlanillaSustitucionDto planillasustitucion, UriTemplate template)
			{
				PlanillaSustitucionDto addedPlanillaSustitucion = this.Create(planillasustitucion);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedPlanillaSustitucion.DtoKey, template));
				ItemInfo<PlanillaSustitucionDto> itemInfo = new ItemInfo<PlanillaSustitucionDto>();
				itemInfo.Item = addedPlanillaSustitucion;
				itemInfo.EditLink = GetItemLink(addedPlanillaSustitucion.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of planillasustitucion with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PlanillaSustitucionDto HandleReadPlanillaSustitucion(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of PlanillaSustitucions with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<PlanillaSustitucionDto> HandleReadPlanillaSustitucions(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.PlanillaSustitucionsPerPageCount > maxEntities)
					{
						this.PlanillaSustitucionsPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.PlanillaSustitucionsPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.PlanillaSustitucionsPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, PlanillaSustitucionDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.PlanillaSustitucionsPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, PlanillaSustitucionDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<PlanillaSustitucionDto>> itemsInfo = new List<ItemInfo<PlanillaSustitucionDto>>();
	
					foreach (KeyValuePair<string, PlanillaSustitucionDto> item in items)
					{
						ItemInfo<PlanillaSustitucionDto> itemInfo = new ItemInfo<PlanillaSustitucionDto>();
					...
					return new ItemInfoList<PlanillaSustitucionDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of planillasustitucion with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="planillasustitucion">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected PlanillaSustitucionDto HandleUpdatePlanillaSustitucion(string dtoKey, PlanillaSustitucionDto planillasustitucion)
			{
				this.Update(dtoKey, planillasustitucion);
	
				return planillasustitucion;
			}
	
			/// <summary>
			/// Handles deleting of planillasustitucion with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeletePlanillaSustitucion(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// PlanillaSustitucionsCollectionService finalizer.
			/// </summary>
			~PlanillaSustitucionsCollectionService()
			{
