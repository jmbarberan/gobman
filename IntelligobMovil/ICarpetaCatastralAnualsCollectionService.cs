...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CarpetaCatastralAnualsCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICarpetaCatastralAnualsCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CarpetaCatastralAnualDto> ReadCarpetaCatastralAnuals();
	    ...
	    [OperationContract]	
	    ItemInfo<CarpetaCatastralAnualDto> CreateCarpetaCatastralAnual(CarpetaCatastralAnualDto carpetacatastralanual);
	    ...
	    [OperationContract]
	    CarpetaCatastralAnualDto UpdateCarpetaCatastralAnual(string dtoKey, CarpetaCatastralAnualDto carpetacatastralanual);
	    ...
	    [OperationContract]    
	    void DeleteCarpetaCatastralAnual(string dtoKey);
	}
}
