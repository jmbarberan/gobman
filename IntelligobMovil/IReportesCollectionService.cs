...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ReportesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IReportesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ReporteDto> ReadReportes();
	    ...
	    [OperationContract]	
	    ItemInfo<ReporteDto> CreateReporte(ReporteDto reporte);
	    ...
	    [OperationContract]
	    ReporteDto UpdateReporte(string dtoKey, ReporteDto reporte);
	    ...
	    [OperationContract]    
	    void DeleteReporte(string dtoKey);
	}
}
