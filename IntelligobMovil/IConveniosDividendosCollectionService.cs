...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ConveniosDividendosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IConveniosDividendosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ConveniosDividendoDto> ReadConveniosDividendos();
	    ...
	    [OperationContract]	
	    ItemInfo<ConveniosDividendoDto> CreateConveniosDividendo(ConveniosDividendoDto conveniosdividendo);
	    ...
	    [OperationContract]
	    ConveniosDividendoDto UpdateConveniosDividendo(string dtoKey, ConveniosDividendoDto conveniosdividendo);
	    ...
	    [OperationContract]    
	    void DeleteConveniosDividendo(string dtoKey);
	}
}
