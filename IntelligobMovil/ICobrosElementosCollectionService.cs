...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CobrosElementosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICobrosElementosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CobrosElementoDto> ReadCobrosElementos();
	    ...
	    [OperationContract]	
	    ItemInfo<CobrosElementoDto> CreateCobrosElemento(CobrosElementoDto cobroselemento);
	    ...
	    [OperationContract]
	    CobrosElementoDto UpdateCobrosElemento(string dtoKey, CobrosElementoDto cobroselemento);
	    ...
	    [OperationContract]    
	    void DeleteCobrosElemento(string dtoKey);
	}
}
