...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RubrosParametrosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRubrosParametrosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RubrosParametroDto> ReadRubrosParametros();
	    ...
	    [OperationContract]	
	    ItemInfo<RubrosParametroDto> CreateRubrosParametro(RubrosParametroDto rubrosparametro);
	    ...
	    [OperationContract]
	    RubrosParametroDto UpdateRubrosParametro(string dtoKey, RubrosParametroDto rubrosparametro);
	    ...
	    [OperationContract]    
	    void DeleteRubrosParametro(string dtoKey);
	}
}
