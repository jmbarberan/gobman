...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PlanillaMesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPlanillaMesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PlanillaMesDto> ReadPlanillaMeses();
	    ...
	    [OperationContract]	
	    ItemInfo<PlanillaMesDto> CreatePlanillaMes(PlanillaMesDto planillames);
	    ...
	    [OperationContract]
	    PlanillaMesDto UpdatePlanillaMes(string dtoKey, PlanillaMesDto planillames);
	    ...
	    [OperationContract]    
	    void DeletePlanillaMes(string dtoKey);
	}
}
