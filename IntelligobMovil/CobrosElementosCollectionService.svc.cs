...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// CobrosElementosCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class CobrosElementosCollectionService : ICobrosElementosCollectionService
		{
			...
			#region ICobrosElementosCollectionService Members
			...
			{
				return this.HandleReadCobrosElemento(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<CobrosElementoDto> ReadCobrosElementos()
			{
				return this.HandleReadCobrosElementos(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="cobroselemento">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<CobrosElementoDto> CreateCobrosElemento(CobrosElementoDto cobroselemento)
			{
				return this.HandleCreateCobrosElemento(cobroselemento, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="cobroselemento">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public CobrosElementoDto UpdateCobrosElemento(string dtoKey, CobrosElementoDto cobroselemento)
			{
				return this.HandleUpdateCobrosElemento(dtoKey, cobroselemento);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeleteCobrosElemento(string dtoKey)
			{
				this.HandleDeleteCobrosElemento(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of CobrosElementos returned per page.
			/// </summary>
			public int CobrosElementosPerPageCount
			{
				get 
				{ 
					return this.cobroselementosPerPageCount; 
				}
				set 
				{
					if (value != this.cobroselementosPerPageCount)
					{
						this.cobroselementosPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual ICobrosElementoService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new CobrosElementoService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a cobroselemento to the database and return the cobroselemento with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="cobroselemento">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected CobrosElementoDto Create(CobrosElementoDto cobroselemento)
			{
				try
				{
					string dtoKey = this.Service.Add(cobroselemento);
					this.UnitOfWork.SaveChanges();
					CobrosElementoDto addedCobrosElemento = this.Read(dtoKey);
					if (addedCobrosElemento == null)
					{
			...
			/// <summary>
			/// Returns the CobrosElementoDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected CobrosElementoDto Read(string dtoKey)
			{
				try
				{
					CobrosElementoDto cobroselemento = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, CobrosElementoDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the cobroselemento with the specified dto key in the database. 
			...
			/// <param name="cobroselemento">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, CobrosElementoDto cobroselemento)
			{
				try
				{
					if (dtoKey != cobroselemento.DtoKey && dtoKey != cobroselemento.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(cobroselemento);
			...
			/// <summary>
			/// Deletes the cobroselemento with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					CobrosElementoDto cobroselemento = Read(dtoKey);
					if (cobroselemento == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(cobroselemento);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the cobroselemento count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of cobroselemento with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="cobroselemento">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<CobrosElementoDto> HandleCreateCobrosElemento(CobrosElementoDto cobroselemento, UriTemplate template)
			{
				CobrosElementoDto addedCobrosElemento = this.Create(cobroselemento);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedCobrosElemento.DtoKey, template));
				ItemInfo<CobrosElementoDto> itemInfo = new ItemInfo<CobrosElementoDto>();
				itemInfo.Item = addedCobrosElemento;
				itemInfo.EditLink = GetItemLink(addedCobrosElemento.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of cobroselemento with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected CobrosElementoDto HandleReadCobrosElemento(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of CobrosElementos with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<CobrosElementoDto> HandleReadCobrosElementos(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.CobrosElementosPerPageCount > maxEntities)
					{
						this.CobrosElementosPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.CobrosElementosPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.CobrosElementosPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, CobrosElementoDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.CobrosElementosPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, CobrosElementoDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<CobrosElementoDto>> itemsInfo = new List<ItemInfo<CobrosElementoDto>>();
	
					foreach (KeyValuePair<string, CobrosElementoDto> item in items)
					{
						ItemInfo<CobrosElementoDto> itemInfo = new ItemInfo<CobrosElementoDto>();
					...
					return new ItemInfoList<CobrosElementoDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of cobroselemento with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="cobroselemento">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected CobrosElementoDto HandleUpdateCobrosElemento(string dtoKey, CobrosElementoDto cobroselemento)
			{
				this.Update(dtoKey, cobroselemento);
	
				return cobroselemento;
			}
	
			/// <summary>
			/// Handles deleting of cobroselemento with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeleteCobrosElemento(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// CobrosElementosCollectionService finalizer.
			/// </summary>
			~CobrosElementosCollectionService()
			{
