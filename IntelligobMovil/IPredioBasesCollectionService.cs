...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioBasesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioBasesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioBaseDto> ReadPredioBases();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioBaseDto> CreatePredioBase(PredioBaseDto prediobase);
	    ...
	    [OperationContract]
	    PredioBaseDto UpdatePredioBase(string dtoKey, PredioBaseDto prediobase);
	    ...
	    [OperationContract]    
	    void DeletePredioBase(string dtoKey);
	}
}
