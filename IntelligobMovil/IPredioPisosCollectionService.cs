...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioPisosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioPisosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioPisoDto> ReadPredioPisos();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioPisoDto> CreatePredioPiso(PredioPisoDto prediopiso);
	    ...
	    [OperationContract]
	    PredioPisoDto UpdatePredioPiso(string dtoKey, PredioPisoDto prediopiso);
	    ...
	    [OperationContract]    
	    void DeletePredioPiso(string dtoKey);
	}
}
