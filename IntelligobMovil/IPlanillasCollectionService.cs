...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PlanillasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPlanillasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PlanillaDto> ReadPlanillas();
	    ...
	    [OperationContract]	
	    ItemInfo<PlanillaDto> CreatePlanilla(PlanillaDto planilla);
	    ...
	    [OperationContract]
	    PlanillaDto UpdatePlanilla(string dtoKey, PlanillaDto planilla);
	    ...
	    [OperationContract]    
	    void DeletePlanilla(string dtoKey);
	}
}
