...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ConceptosEmisionsCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IConceptosEmisionsCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ConceptosEmisionDto> ReadConceptosEmisions();
	    ...
	    [OperationContract]	
	    ItemInfo<ConceptosEmisionDto> CreateConceptosEmision(ConceptosEmisionDto conceptosemision);
	    ...
	    [OperationContract]
	    ConceptosEmisionDto UpdateConceptosEmision(string dtoKey, ConceptosEmisionDto conceptosemision);
	    ...
	    [OperationContract]    
	    void DeleteConceptosEmision(string dtoKey);
	}
}
