...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CuentaBancariasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICuentaBancariasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CuentaBancariaDto> ReadCuentaBancarias();
	    ...
	    [OperationContract]	
	    ItemInfo<CuentaBancariaDto> CreateCuentaBancaria(CuentaBancariaDto cuentabancaria);
	    ...
	    [OperationContract]
	    CuentaBancariaDto UpdateCuentaBancaria(string dtoKey, CuentaBancariaDto cuentabancaria);
	    ...
	    [OperationContract]    
	    void DeleteCuentaBancaria(string dtoKey);
	}
}
