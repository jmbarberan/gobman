...
namespace IntelligobMovil.Dto
{
	...
	[KnownType(typeof(PlanillaMesDto))]
	public partial class PlanillaDto : IDtoWithKey
	{
		...
		public PlanillaDto(int mId, int? mConcepto, string mCodigo, int? mAño, int? mMes, int? mContribuyente, int? mServicio, double? mTotal, double? mPagos, double? mRecargos, double? mRebajas, double? mConvenios, DateTime? mFechaemision, DateTime? mFechacancelacion, int? mUsuario, string mComentarios, int? mNumero, int? mEspecie, int? mEstado, string mContribuyentes, int? mSoportenumero, ContribuyenteDto mContribuyente1, ConceptoDto mConcepto1, IList<PlanillaRubroDto> mPlanillasrubros, IList<PlanillaAtributoDto> mPlanillasatributos, IList<PlanillaMesDto> mPlanillasmeses)
		{
			...
			this.PlanillaMesesNav = mPlanillasmeses;
		}
		...
		[DataMember]
		public virtual IList<PlanillaMesDto> PlanillaMesesNav { get;set; }
	...
	public partial class RepRecaudacionesFechaDto : IDtoWithKey
	{
		...
		public RepRecaudacionesFechaDto(double? mTotal, double? mRecargos, double? mRebajas, double? mPagos, int? mNumero, DateTime? mFecha, int? mConcepto, string mCodigo, int? mAño, int mId, string mNombres, string mConceptoden, int? mSoportenumero, int? mEstado, int? mFormapago)
		{
			this.Total = mTotal;
			this.Recargos = mRecargos;
			this.Rebajas = mRebajas;
	...
	[DataContract]
	[KnownType(typeof(RubroDto))]
	public partial class PlanillaMesDto : IDtoWithKey
	{
		public PlanillaMesDto()
		{
		}
		
		public PlanillaMesDto(int mId, int? mPlanilla, int? mRubro, double? mMes1, double? mMes2, double? mMes3, double? mMes4, double? mMes5, double? mMes6, double? mMes7, double? mMes8, double? mMes9, double? mMes10, double? mMes11, double? mMes12, double? mEstado, RubroDto mRubro1)
		{
			this.Id = mId;
			this.Planilla = mPlanilla;
			this.Rubro = mRubro;
	...
	[DataContract]
	[KnownType(typeof(ContribuyenteDto))]
	public partial class MercadoDto : IDtoWithKey
	{
		public MercadoDto()
		{
		}
		
		public MercadoDto(int mId, int? mPuesto, string mActividad, int? mContribuyente, int? mContrato, DateTime? mInscripcionfecha, DateTime? mDesde, DateTime? mHasta, string mObservaciones, string mCodigo, int? mUbicacion, int? mEstado, ContribuyenteDto mContribuyente1)
		{
			this.Id = mId;
			this.Puesto = mPuesto;
			this.Actividad = mActividad;
			this.Contribuyente = mContribuyente;
			this.Contrato = mContrato;
			this.InscripcionFecha = mInscripcionfecha;
			this.Desde = mDesde;
			this.Hasta = mHasta;
			this.Observaciones = mObservaciones;
			this.Codigo = mCodigo;
		...
		[DataMember]
		public virtual DateTime? InscripcionFecha { get;set; }
