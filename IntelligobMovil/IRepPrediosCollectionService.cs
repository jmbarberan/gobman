...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// RepPrediosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IRepPrediosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<RepPredioDto> ReadRepPredios();
	    ...
	    [OperationContract]	
	    ItemInfo<RepPredioDto> CreateRepPredio(RepPredioDto reppredio);
	    ...
	    [OperationContract]
	    RepPredioDto UpdateRepPredio(string dtoKey, RepPredioDto reppredio);
	    ...
	    [OperationContract]    
	    void DeleteRepPredio(string dtoKey);
	}
}
