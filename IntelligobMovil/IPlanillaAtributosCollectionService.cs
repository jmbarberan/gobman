...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PlanillaAtributosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPlanillaAtributosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PlanillaAtributoDto> ReadPlanillaAtributos();
	    ...
	    [OperationContract]	
	    ItemInfo<PlanillaAtributoDto> CreatePlanillaAtributo(PlanillaAtributoDto planillaatributo);
	    ...
	    [OperationContract]
	    PlanillaAtributoDto UpdatePlanillaAtributo(string dtoKey, PlanillaAtributoDto planillaatributo);
	    ...
	    [OperationContract]    
	    void DeletePlanillaAtributo(string dtoKey);
	}
}
