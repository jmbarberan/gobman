...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// ConceptosEmisionsCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class ConceptosEmisionsCollectionService : IConceptosEmisionsCollectionService
		{
			...
			#region IConceptosEmisionsCollectionService Members
			...
			{
				return this.HandleReadConceptosEmision(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<ConceptosEmisionDto> ReadConceptosEmisions()
			{
				return this.HandleReadConceptosEmisions(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="conceptosemision">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<ConceptosEmisionDto> CreateConceptosEmision(ConceptosEmisionDto conceptosemision)
			{
				return this.HandleCreateConceptosEmision(conceptosemision, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="conceptosemision">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public ConceptosEmisionDto UpdateConceptosEmision(string dtoKey, ConceptosEmisionDto conceptosemision)
			{
				return this.HandleUpdateConceptosEmision(dtoKey, conceptosemision);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeleteConceptosEmision(string dtoKey)
			{
				this.HandleDeleteConceptosEmision(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of ConceptosEmisions returned per page.
			/// </summary>
			public int ConceptosEmisionsPerPageCount
			{
				get 
				{ 
					return this.conceptosemisionsPerPageCount; 
				}
				set 
				{
					if (value != this.conceptosemisionsPerPageCount)
					{
						this.conceptosemisionsPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IConceptosEmisionService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new ConceptosEmisionService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a conceptosemision to the database and return the conceptosemision with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="conceptosemision">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected ConceptosEmisionDto Create(ConceptosEmisionDto conceptosemision)
			{
				try
				{
					string dtoKey = this.Service.Add(conceptosemision);
					this.UnitOfWork.SaveChanges();
					ConceptosEmisionDto addedConceptosEmision = this.Read(dtoKey);
					if (addedConceptosEmision == null)
					{
			...
			/// <summary>
			/// Returns the ConceptosEmisionDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected ConceptosEmisionDto Read(string dtoKey)
			{
				try
				{
					ConceptosEmisionDto conceptosemision = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, ConceptosEmisionDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the conceptosemision with the specified dto key in the database. 
			...
			/// <param name="conceptosemision">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, ConceptosEmisionDto conceptosemision)
			{
				try
				{
					if (dtoKey != conceptosemision.DtoKey && dtoKey != conceptosemision.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(conceptosemision);
			...
			/// <summary>
			/// Deletes the conceptosemision with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					ConceptosEmisionDto conceptosemision = Read(dtoKey);
					if (conceptosemision == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(conceptosemision);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the conceptosemision count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of conceptosemision with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="conceptosemision">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<ConceptosEmisionDto> HandleCreateConceptosEmision(ConceptosEmisionDto conceptosemision, UriTemplate template)
			{
				ConceptosEmisionDto addedConceptosEmision = this.Create(conceptosemision);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedConceptosEmision.DtoKey, template));
				ItemInfo<ConceptosEmisionDto> itemInfo = new ItemInfo<ConceptosEmisionDto>();
				itemInfo.Item = addedConceptosEmision;
				itemInfo.EditLink = GetItemLink(addedConceptosEmision.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of conceptosemision with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected ConceptosEmisionDto HandleReadConceptosEmision(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of ConceptosEmisions with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<ConceptosEmisionDto> HandleReadConceptosEmisions(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.ConceptosEmisionsPerPageCount > maxEntities)
					{
						this.ConceptosEmisionsPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.ConceptosEmisionsPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.ConceptosEmisionsPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, ConceptosEmisionDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.ConceptosEmisionsPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, ConceptosEmisionDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<ConceptosEmisionDto>> itemsInfo = new List<ItemInfo<ConceptosEmisionDto>>();
	
					foreach (KeyValuePair<string, ConceptosEmisionDto> item in items)
					{
						ItemInfo<ConceptosEmisionDto> itemInfo = new ItemInfo<ConceptosEmisionDto>();
					...
					return new ItemInfoList<ConceptosEmisionDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of conceptosemision with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="conceptosemision">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected ConceptosEmisionDto HandleUpdateConceptosEmision(string dtoKey, ConceptosEmisionDto conceptosemision)
			{
				this.Update(dtoKey, conceptosemision);
	
				return conceptosemision;
			}
	
			/// <summary>
			/// Handles deleting of conceptosemision with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeleteConceptosEmision(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// ConceptosEmisionsCollectionService finalizer.
			/// </summary>
			~ConceptosEmisionsCollectionService()
			{
