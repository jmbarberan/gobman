...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ComandosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IComandosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ComandoDto> ReadComandos();
	    ...
	    [OperationContract]	
	    ItemInfo<ComandoDto> CreateComando(ComandoDto comando);
	    ...
	    [OperationContract]
	    ComandoDto UpdateComando(string dtoKey, ComandoDto comando);
	    ...
	    [OperationContract]    
	    void DeleteComando(string dtoKey);
	}
}
