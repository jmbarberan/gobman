...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// MejoraElementosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IMejoraElementosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<MejoraElementoDto> ReadMejoraElementos();
	    ...
	    [OperationContract]	
	    ItemInfo<MejoraElementoDto> CreateMejoraElemento(MejoraElementoDto mejoraelemento);
	    ...
	    [OperationContract]
	    MejoraElementoDto UpdateMejoraElemento(string dtoKey, MejoraElementoDto mejoraelemento);
	    ...
	    [OperationContract]    
	    void DeleteMejoraElemento(string dtoKey);
	}
}
