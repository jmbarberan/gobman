...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioFotosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioFotosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioFotoDto> ReadPredioFotos();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioFotoDto> CreatePredioFoto(PredioFotoDto prediofoto);
	    ...
	    [OperationContract]
	    PredioFotoDto UpdatePredioFoto(string dtoKey, PredioFotoDto prediofoto);
	    ...
	    [OperationContract]    
	    void DeletePredioFoto(string dtoKey);
	}
}
