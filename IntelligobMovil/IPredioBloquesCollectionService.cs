...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioBloquesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioBloquesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioBloqueDto> ReadPredioBloques();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioBloqueDto> CreatePredioBloque(PredioBloqueDto prediobloque);
	    ...
	    [OperationContract]
	    PredioBloqueDto UpdatePredioBloque(string dtoKey, PredioBloqueDto prediobloque);
	    ...
	    [OperationContract]    
	    void DeletePredioBloque(string dtoKey);
	}
}
