...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// ContribuyentesRebajasCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class ContribuyentesRebajasCollectionService : IContribuyentesRebajasCollectionService
		{
			...
			#region IContribuyentesRebajasCollectionService Members
			...
			{
				return this.HandleReadContribuyentesRebaja(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<ContribuyentesRebajaDto> ReadContribuyentesRebajas()
			{
				return this.HandleReadContribuyentesRebajas(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="contribuyentesrebaja">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<ContribuyentesRebajaDto> CreateContribuyentesRebaja(ContribuyentesRebajaDto contribuyentesrebaja)
			{
				return this.HandleCreateContribuyentesRebaja(contribuyentesrebaja, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="contribuyentesrebaja">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public ContribuyentesRebajaDto UpdateContribuyentesRebaja(string dtoKey, ContribuyentesRebajaDto contribuyentesrebaja)
			{
				return this.HandleUpdateContribuyentesRebaja(dtoKey, contribuyentesrebaja);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeleteContribuyentesRebaja(string dtoKey)
			{
				this.HandleDeleteContribuyentesRebaja(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of ContribuyentesRebajas returned per page.
			/// </summary>
			public int ContribuyentesRebajasPerPageCount
			{
				get 
				{ 
					return this.contribuyentesrebajasPerPageCount; 
				}
				set 
				{
					if (value != this.contribuyentesrebajasPerPageCount)
					{
						this.contribuyentesrebajasPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IContribuyentesRebajaService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new ContribuyentesRebajaService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a contribuyentesrebaja to the database and return the contribuyentesrebaja with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="contribuyentesrebaja">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected ContribuyentesRebajaDto Create(ContribuyentesRebajaDto contribuyentesrebaja)
			{
				try
				{
					string dtoKey = this.Service.Add(contribuyentesrebaja);
					this.UnitOfWork.SaveChanges();
					ContribuyentesRebajaDto addedContribuyentesRebaja = this.Read(dtoKey);
					if (addedContribuyentesRebaja == null)
					{
					...
					return addedContribuyentesRebaja;
				}
			...
			/// <summary>
			/// Returns the ContribuyentesRebajaDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected ContribuyentesRebajaDto Read(string dtoKey)
			{
				try
				{
					ContribuyentesRebajaDto contribuyentesrebaja = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, ContribuyentesRebajaDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the contribuyentesrebaja with the specified dto key in the database. 
			...
			/// <param name="contribuyentesrebaja">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, ContribuyentesRebajaDto contribuyentesrebaja)
			{
				try
				{
					if (dtoKey != contribuyentesrebaja.DtoKey && dtoKey != contribuyentesrebaja.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(contribuyentesrebaja);
			...
			/// <summary>
			/// Deletes the contribuyentesrebaja with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					ContribuyentesRebajaDto contribuyentesrebaja = Read(dtoKey);
					if (contribuyentesrebaja == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(contribuyentesrebaja);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the contribuyentesrebaja count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of contribuyentesrebaja with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="contribuyentesrebaja">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<ContribuyentesRebajaDto> HandleCreateContribuyentesRebaja(ContribuyentesRebajaDto contribuyentesrebaja, UriTemplate template)
			{
				ContribuyentesRebajaDto addedContribuyentesRebaja = this.Create(contribuyentesrebaja);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedContribuyentesRebaja.DtoKey, template));
				ItemInfo<ContribuyentesRebajaDto> itemInfo = new ItemInfo<ContribuyentesRebajaDto>();
				itemInfo.Item = addedContribuyentesRebaja;
				itemInfo.EditLink = GetItemLink(addedContribuyentesRebaja.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of contribuyentesrebaja with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected ContribuyentesRebajaDto HandleReadContribuyentesRebaja(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of ContribuyentesRebajas with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<ContribuyentesRebajaDto> HandleReadContribuyentesRebajas(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.ContribuyentesRebajasPerPageCount > maxEntities)
					{
						this.ContribuyentesRebajasPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.ContribuyentesRebajasPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.ContribuyentesRebajasPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, ContribuyentesRebajaDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.ContribuyentesRebajasPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, ContribuyentesRebajaDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<ContribuyentesRebajaDto>> itemsInfo = new List<ItemInfo<ContribuyentesRebajaDto>>();
	
					foreach (KeyValuePair<string, ContribuyentesRebajaDto> item in items)
					{
						ItemInfo<ContribuyentesRebajaDto> itemInfo = new ItemInfo<ContribuyentesRebajaDto>();
					...
					return new ItemInfoList<ContribuyentesRebajaDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of contribuyentesrebaja with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="contribuyentesrebaja">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected ContribuyentesRebajaDto HandleUpdateContribuyentesRebaja(string dtoKey, ContribuyentesRebajaDto contribuyentesrebaja)
			{
				this.Update(dtoKey, contribuyentesrebaja);
	
				return contribuyentesrebaja;
			}
	
			/// <summary>
			/// Handles deleting of contribuyentesrebaja with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeleteContribuyentesRebaja(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// ContribuyentesRebajasCollectionService finalizer.
			/// </summary>
			~ContribuyentesRebajasCollectionService()
			{
