...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PlanillaSustitucionsCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPlanillaSustitucionsCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PlanillaSustitucionDto> ReadPlanillaSustitucions();
	    ...
	    [OperationContract]	
	    ItemInfo<PlanillaSustitucionDto> CreatePlanillaSustitucion(PlanillaSustitucionDto planillasustitucion);
	    ...
	    [OperationContract]
	    PlanillaSustitucionDto UpdatePlanillaSustitucion(string dtoKey, PlanillaSustitucionDto planillasustitucion);
	    ...
	    [OperationContract]    
	    void DeletePlanillaSustitucion(string dtoKey);
	}
}
