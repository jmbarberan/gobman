...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// CobrosNotasCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface ICobrosNotasCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<CobrosNotaDto> ReadCobrosNotas();
	    ...
	    [OperationContract]	
	    ItemInfo<CobrosNotaDto> CreateCobrosNota(CobrosNotaDto cobrosnota);
	    ...
	    [OperationContract]
	    CobrosNotaDto UpdateCobrosNota(string dtoKey, CobrosNotaDto cobrosnota);
	    ...
	    [OperationContract]    
	    void DeleteCobrosNota(string dtoKey);
	}
}
