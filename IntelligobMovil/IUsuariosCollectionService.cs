...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// UsuariosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IUsuariosCollectionService
	{
	    ...
	    [OperationContract]
	    ItemInfoList<UsuarioDto> ReadUsuarios();
	    ...
	    [OperationContract]	
	    ItemInfo<UsuarioDto> CreateUsuario(UsuarioDto usuario);
	    ...
	    [OperationContract]
	    UsuarioDto UpdateUsuario(string dtoKey, UsuarioDto usuario);
	    ...
	    [OperationContract]    
	    void DeleteUsuario(string dtoKey);
	}
}
