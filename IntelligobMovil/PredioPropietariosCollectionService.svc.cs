...
namespace IntelligobMovil
{
	...
	using System.Runtime.Serialization;
		...
		/// <summary>
		/// PredioPropietariosCollectionService service class handler.
		/// </summary> 
		[ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
		public partial class PredioPropietariosCollectionService : IPredioPropietariosCollectionService
		{
			...
			#region IPredioPropietariosCollectionService Members
			...
			{
				return this.HandleReadPredioPropietario(dtoKey);
			}
			...
			/// </summary>
			/// <returns></returns>
			public ItemInfoList<PredioPropietarioDto> ReadPredioPropietarios()
			{
				return this.HandleReadPredioPropietarios(itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="prediopropietario">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			public ItemInfo<PredioPropietarioDto> CreatePredioPropietario(PredioPropietarioDto prediopropietario)
			{
				return this.HandleCreatePredioPropietario(prediopropietario, itemUriTemplate);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="prediopropietario">The dto that holds the data to be updated.</param>	
			/// <returns></returns>
			public PredioPropietarioDto UpdatePredioPropietario(string dtoKey, PredioPropietarioDto prediopropietario)
			{
				return this.HandleUpdatePredioPropietario(dtoKey, prediopropietario);
			}
			...
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			public void DeletePredioPropietario(string dtoKey)
			{
				this.HandleDeletePredioPropietario(dtoKey);
			}
			...
			/// <summary>
			/// Gets or sets the number of PredioPropietarios returned per page.
			/// </summary>
			public int PredioPropietariosPerPageCount
			{
				get 
				{ 
					return this.prediopropietariosPerPageCount; 
				}
				set 
				{
					if (value != this.prediopropietariosPerPageCount)
					{
						this.prediopropietariosPerPageCount = value;
					}
				}
			}
			...
			/// </summary>
			protected virtual IPredioPropietarioService Service
			{
				get
				{
					if (this.service == null)
					{
						...
						this.service = new PredioPropietarioService(assembler, repository);
					}
					return this.service;
				}
			}
			...
			/// <summary>
			/// Adds a prediopropietario to the database and return the prediopropietario with updated dto key. Returns null if adding the item failed.
			/// A null return value will result in a response status code of InternalServerError (500).
			/// </summary>
			/// <param name="prediopropietario">The dto that holds the data to be inserted.</param>
			/// <returns></returns>
			protected PredioPropietarioDto Create(PredioPropietarioDto prediopropietario)
			{
				try
				{
					string dtoKey = this.Service.Add(prediopropietario);
					this.UnitOfWork.SaveChanges();
					PredioPropietarioDto addedPredioPropietario = this.Read(dtoKey);
					if (addedPredioPropietario == null)
					{
			...
			/// <summary>
			/// Returns the PredioPropietarioDto with the given dto key. 
			...
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PredioPropietarioDto Read(string dtoKey)
			{
				try
				{
					PredioPropietarioDto prediopropietario = this.Service.GetByKey(dtoKey);
			...
			/// <returns></returns>
			protected IEnumerable<KeyValuePair<string, PredioPropietarioDto>> Read(int startRowIndex, int maximumRows)
			{
			...
			/// <summary>
			/// Updates the prediopropietario with the specified dto key in the database. 
			...
			/// <param name="prediopropietario">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected void Update(string dtoKey, PredioPropietarioDto prediopropietario)
			{
				try
				{
					if (dtoKey != prediopropietario.DtoKey && dtoKey != prediopropietario.Id.ToString(string.Empty, CultureInfo.InvariantCulture))
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.BadRequest;
					...
					this.Service.Update(prediopropietario);
			...
			/// <summary>
			/// Deletes the prediopropietario with the specified dto key from the database.
			/// A response status code of NotFound (404) will be the result if the item does not exist.
			/// A response status code of InternalServerError (500) will be the result if an error occur.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			...
			protected bool Delete(string dtoKey)
			{
				try
				{
					PredioPropietarioDto prediopropietario = Read(dtoKey);
					if (prediopropietario == null)
					{
						OutgoingWebResponseContext response = WebOperationContext.Current.OutgoingResponse;
						response.StatusCode = HttpStatusCode.NotFound;
					...
					this.Service.Delete(prediopropietario);
					this.UnitOfWork.SaveChanges();
			...
			/// <summary>
			/// Returns the prediopropietario count.
			/// </summary>
			/// <returns></returns>
			protected int Count()
			{
			...
			/// <summary>
			/// Handles adding of prediopropietario with a specified URI template and return a wrapped item info object.
			/// </summary>
			/// <param name="prediopropietario">The dto that holds the data to be added.</param>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfo<PredioPropietarioDto> HandleCreatePredioPropietario(PredioPropietarioDto prediopropietario, UriTemplate template)
			{
				PredioPropietarioDto addedPredioPropietario = this.Create(prediopropietario);
	
				WebOperationContext.Current.OutgoingResponse.SetStatusAsCreated(GetItemLink(addedPredioPropietario.DtoKey, template));
				ItemInfo<PredioPropietarioDto> itemInfo = new ItemInfo<PredioPropietarioDto>();
				itemInfo.Item = addedPredioPropietario;
				itemInfo.EditLink = GetItemLink(addedPredioPropietario.DtoKey, template);
	
				return itemInfo;
			}
	
			/// <summary>
			/// Handles reading of prediopropietario with a specified dto key and return a dto.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <returns></returns>
			protected PredioPropietarioDto HandleReadPredioPropietario(string dtoKey)
			{
				return this.Read(dtoKey);
			}
	
			/// <summary>
			/// Handles reading of PredioPropietarios with a specified URI template and return a wrapped item info object list.
			/// </summary>
			/// <param name="template">The URI template to be used.</param>
			/// <returns></returns>
			protected ItemInfoList<PredioPropietarioDto> HandleReadPredioPropietarios(UriTemplate template)
			{
				int startIndex = 0;
				...
				if (pageQueryParam != null)
				{
					...
					if (this.PredioPropietariosPerPageCount > maxEntities)
					{
						this.PredioPropietariosPerPageCount = maxEntities;
					}
	
					bool hasMoreEntries = pageNumber * this.PredioPropietariosPerPageCount < maxEntities;
					...
					startIndex = pageNumber * this.PredioPropietariosPerPageCount;
				}
	
				IEnumerable<KeyValuePair<string, PredioPropietarioDto>> items =
					this.Read(
						startIndex,
						(pageQueryParam != null) ? this.PredioPropietariosPerPageCount : maxEntities);
	
				if (items == null)
				{
					items = new List<KeyValuePair<string, PredioPropietarioDto>>();
	
					return null;
				}
				else
				{
					List<ItemInfo<PredioPropietarioDto>> itemsInfo = new List<ItemInfo<PredioPropietarioDto>>();
	
					foreach (KeyValuePair<string, PredioPropietarioDto> item in items)
					{
						ItemInfo<PredioPropietarioDto> itemInfo = new ItemInfo<PredioPropietarioDto>();
					...
					return new ItemInfoList<PredioPropietarioDto>(itemsInfo, nextPageLink, previousPageLink);
				}
			}
	
			/// <summary>
			/// Handles updating of prediopropietario with a specified dto key and return a the same dto with updated dto key property.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			/// <param name="prediopropietario">The dto that holds the data to be updated.</param>
			/// <returns></returns>
			protected PredioPropietarioDto HandleUpdatePredioPropietario(string dtoKey, PredioPropietarioDto prediopropietario)
			{
				this.Update(dtoKey, prediopropietario);
	
				return prediopropietario;
			}
	
			/// <summary>
			/// Handles deleting of prediopropietario with a specified dto key.
			/// </summary>
			/// <param name="dtoKey">The specified dto key value.</param>
			protected void HandleDeletePredioPropietario(string dtoKey)
			{
				this.Delete(dtoKey);
			}
			...
			/// <summary>
			/// PredioPropietariosCollectionService finalizer.
			/// </summary>
			~PredioPropietariosCollectionService()
			{
