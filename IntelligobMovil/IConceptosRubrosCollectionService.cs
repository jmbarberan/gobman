...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ConceptosRubrosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IConceptosRubrosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ConceptosRubroDto> ReadConceptosRubros();
	    ...
	    [OperationContract]	
	    ItemInfo<ConceptosRubroDto> CreateConceptosRubro(ConceptosRubroDto conceptosrubro);
	    ...
	    [OperationContract]
	    ConceptosRubroDto UpdateConceptosRubro(string dtoKey, ConceptosRubroDto conceptosrubro);
	    ...
	    [OperationContract]    
	    void DeleteConceptosRubro(string dtoKey);
	}
}
