...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ConveniosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IConveniosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ConvenioDto> ReadConvenios();
	    ...
	    [OperationContract]	
	    ItemInfo<ConvenioDto> CreateConvenio(ConvenioDto convenio);
	    ...
	    [OperationContract]
	    ConvenioDto UpdateConvenio(string dtoKey, ConvenioDto convenio);
	    ...
	    [OperationContract]    
	    void DeleteConvenio(string dtoKey);
	}
}
