...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioConstruccionsCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioConstruccionsCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioConstruccionDto> ReadPredioConstruccions();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioConstruccionDto> CreatePredioConstruccion(PredioConstruccionDto predioconstruccion);
	    ...
	    [OperationContract]
	    PredioConstruccionDto UpdatePredioConstruccion(string dtoKey, PredioConstruccionDto predioconstruccion);
	    ...
	    [OperationContract]    
	    void DeletePredioConstruccion(string dtoKey);
	}
}
