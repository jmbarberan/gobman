...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ConceptosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IConceptosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ConceptoDto> ReadConceptos();
	    ...
	    [OperationContract]	
	    ItemInfo<ConceptoDto> CreateConcepto(ConceptoDto concepto);
	    ...
	    [OperationContract]
	    ConceptoDto UpdateConcepto(string dtoKey, ConceptoDto concepto);
	    ...
	    [OperationContract]    
	    void DeleteConcepto(string dtoKey);
	}
}
