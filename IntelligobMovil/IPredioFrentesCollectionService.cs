...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// PredioFrentesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IPredioFrentesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<PredioFrenteDto> ReadPredioFrentes();
	    ...
	    [OperationContract]	
	    ItemInfo<PredioFrenteDto> CreatePredioFrente(PredioFrenteDto prediofrente);
	    ...
	    [OperationContract]
	    PredioFrenteDto UpdatePredioFrente(string dtoKey, PredioFrenteDto prediofrente);
	    ...
	    [OperationContract]    
	    void DeletePredioFrente(string dtoKey);
	}
}
