...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// ModulosCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IModulosCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<ModuloDto> ReadModulos();
	    ...
	    [OperationContract]	
	    ItemInfo<ModuloDto> CreateModulo(ModuloDto modulo);
	    ...
	    [OperationContract]
	    ModuloDto UpdateModulo(string dtoKey, ModuloDto modulo);
	    ...
	    [OperationContract]    
	    void DeleteModulo(string dtoKey);
	}
}
