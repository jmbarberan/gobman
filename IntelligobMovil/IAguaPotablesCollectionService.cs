...
namespace IntelligobMovil
{
	...
	/// <summary>
	/// AguaPotablesCollectionService interface.
	/// </summary>
	[ServiceContract]
	public interface IAguaPotablesCollectionService
	{
	    /// <summary>
	    ...
	    [OperationContract]
	    ItemInfoList<AguaPotableDto> ReadAguaPotables();
	    ...
	    [OperationContract]	
	    ItemInfo<AguaPotableDto> CreateAguaPotable(AguaPotableDto aguapotable);
	    ...
	    [OperationContract]
	    AguaPotableDto UpdateAguaPotable(string dtoKey, AguaPotableDto aguapotable);
	    ...
	    [OperationContract]    
	    void DeleteAguaPotable(string dtoKey);
	}
}
