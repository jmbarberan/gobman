...
namespace Intelligob.Servidor
{
	...
	public partial class Entidades : IEntidades
	{
	    ...
	    /// <summary>
	    /// A general purpose generated service used for all CRUD operations against Mercado entity.
	    /// </summary>
	    private IMercadoService mercadoservice;
	    
	    /// <summary>
	    /// Gets or sets the general purpose generated service used for all CRUD operations against Mercado entity.
	    /// </summary>
	    public virtual IMercadoService MercadoService
	    {
	        get
	        {
	            if (this.mercadoservice == null)
	            {
	                IMercadoAssembler assembler = new MercadoAssembler();
	                IMercadoRepository repository = new MercadoRepository(this.UnitOfWork);
	
	                this.mercadoservice = new MercadoService(assembler, repository);
	            }
	            return this.mercadoservice;
	        }
	    }
	        
	    #region Mercados CRUD Operations
	
	    /// <summary>
	    /// Returns all mercados.
	    /// </summary>
	    /// <returns></returns>
	    public IEnumerable<MercadoDto> ReadMercados()	
	    {
	        return this.MercadoService.GetAll();
	    }
	
	    /// <summary>
	    /// Returns a specified amount of mercados from the given start index.
	    /// </summary>
	    /// <param name="startIndex">The start index.</param>
	    /// <param name="pageSize">The returned entities count.</param>
	    /// <returns></returns>
	    public IEnumerable<MercadoDto> ReadMercadosPaged(int startIndex, int pageSize)
	    {
	        return this.MercadoService.Find(startIndex, pageSize);
	    }
	
	    /// <summary>
	    /// Returns all mercados filtered by the specified filter expression and sorted by the specified sort expression.
	    /// </summary>
	    /// <param name="sortExpression">The sort expression.</param>
	    /// <param name="filterExpression">The filter expression.</param>
	    /// <returns></returns>
	    public IEnumerable<MercadoDto> ReadMercadosFiltered(string sortExpression, string filterExpression)
	    {
	        return this.MercadoService.Find(sortExpression, filterExpression);
	    }
	
	    /// <summary>
	    /// Returns a specified amount of mercados from the given start index filtered by the specified filter expression and sorted by the specified sort expression.
	    /// </summary>
	    /// <param name="startIndex">The start index.</param>
	    /// <param name="pageSize">The returned entities count.</param>
	    /// <param name="sortExpression">The sort expression.</param>
	    /// <param name="filterExpression">The filter expression.</param>
	    /// <returns></returns>
	    public IEnumerable<MercadoDto> ReadMercadosPagedAndFiltered(int startIndex, int pageSize, string sortExpression, string filterExpression)
	    {
	        return this.MercadoService.Find(startIndex, pageSize, sortExpression, filterExpression);
	    }
	
	    /// <summary>
	    /// Returns a mercado with the specified dto key.
	    /// </summary>
	    /// <param name="dtoKey">The specified dto key value.</param>
	    /// <returns></returns>
	    public MercadoDto ReadMercado(string dtoKey)
	    {
	        return this.MercadoService.GetByKey(dtoKey);
	    }
	    
	    /// <summary>
	    /// Returns all mercados count.
	    /// </summary>
	    /// <returns></returns>
	    public int MercadosCount()
	    {
	        return this.MercadoService.Count();
	    }
	    
	    /// <summary>
	    /// Returns all mercados count filtered by the specified filter expression.
	    /// </summary>
	    /// <param name="filterExpression">The filter expression.</param>
	    /// <returns></returns>
	    public int MercadosCountFiltered(string filterExpression)
	    {
	        return this.MercadoService.Count(filterExpression);
	    }
	
	    /// <summary>
	    /// Adds a new mercado from the given dto object into the database.
	    /// </summary>
	    /// <param name="mercado">The dto object.</param>
	    /// <returns>The dto key of the newly created mercado.</returns>
	    public string CreateMercado(MercadoDto mercado)
	    {
	        string key = this.MercadoService.Add(mercado);
	        this.UnitOfWork.SaveChanges();
	        return key;
	    }
	
	    /// <summary>
	    /// Updates an existing mercado in the database from the given dto object.
	    /// </summary>
	    /// <param name="mercado">The dto object.</param>
	    public void UpdateMercado(MercadoDto mercado)
	    {
	        this.MercadoService.Update(mercado);
	        this.UnitOfWork.SaveChanges();
	    }
	
	    /// <summary>
	    /// Update mercados in the database from the given dto object list.
	    /// </summary>
	    /// <param name="mercados">The dto object list.</param>
	    public void UpdateMercados(IEnumerable<MercadoDto> mercados)
	    {
	        if (mercados == null)
	        {
	            return;
	        ...
	        foreach (MercadoDto mercado in mercados)
	        {
	            if (mercado == null)
	            {
	                continue;
	            ...
	            this.UpdateMercado(mercado);
	        }
	    }
	
	    /// <summary>
	    /// Deletes mercado from the database by the given dto object.
	    /// </summary>
	    /// <param name="mercado">The dto object.</param>
	    public void DeleteMercado(MercadoDto mercado)
	    {
	        this.MercadoService.Delete(mercado);
	        this.UnitOfWork.SaveChanges();		
	    }
	
	    /// <summary>
	    /// Delete mercados from the database by the given dto object list.
	    /// </summary>
	    /// <param name="mercados">The dto object list.</param>
	    public void DeleteMercados(IEnumerable<MercadoDto> mercados)
	    {
	        if (mercados == null)
	        {
	            return;
	    ...
	    /// </summary>
	    private IPlanillaMesService planillamesservice;
	    
	    /// <summary>
	    /// Gets or sets the general purpose generated service used for all CRUD operations against PlanillaMes entity.
	    /// </summary>
	    public virtual IPlanillaMesService PlanillaMesService
	    {
	        get
	        {
	            if (this.planillamesservice == null)
	            {
	                ...
	                this.planillamesservice = new PlanillaMesService(assembler, repository);
	            }
	            return this.planillamesservice;
	        }
	    }
	        
	    #region PlanillaMeses CRUD Operations
	
	    /// <summary>
	    /// Returns all planillameses.
	    /// </summary>
	    /// <returns></returns>
	    public IEnumerable<PlanillaMesDto> ReadPlanillaMeses()	
	    {
	        return this.PlanillaMesService.GetAll();
	    }
	
	    /// <summary>
	    /// Returns a specified amount of planillameses from the given start index.
	    /// </summary>
	    /// <param name="startIndex">The start index.</param>
	    /// <param name="pageSize">The returned entities count.</param>
	    /// <returns></returns>
	    public IEnumerable<PlanillaMesDto> ReadPlanillaMesesPaged(int startIndex, int pageSize)
	    {
	        return this.PlanillaMesService.Find(startIndex, pageSize);
	    }
	
	    /// <summary>
	    /// Returns all planillameses filtered by the specified filter expression and sorted by the specified sort expression.
	    /// </summary>
	    /// <param name="sortExpression">The sort expression.</param>
	    /// <param name="filterExpression">The filter expression.</param>
	    /// <returns></returns>
	    public IEnumerable<PlanillaMesDto> ReadPlanillaMesesFiltered(string sortExpression, string filterExpression)
	    {
	        return this.PlanillaMesService.Find(sortExpression, filterExpression);
	    }
	
	    /// <summary>
	    /// Returns a specified amount of planillameses from the given start index filtered by the specified filter expression and sorted by the specified sort expression.
	    /// </summary>
	    /// <param name="startIndex">The start index.</param>
	    /// <param name="pageSize">The returned entities count.</param>
	    /// <param name="sortExpression">The sort expression.</param>
	    /// <param name="filterExpression">The filter expression.</param>
	    /// <returns></returns>
	    public IEnumerable<PlanillaMesDto> ReadPlanillaMesesPagedAndFiltered(int startIndex, int pageSize, string sortExpression, string filterExpression)
	    {
	        return this.PlanillaMesService.Find(startIndex, pageSize, sortExpression, filterExpression);
	    }
	
	    /// <summary>
	    /// Returns a planillames with the specified dto key.
	    /// </summary>
	    /// <param name="dtoKey">The specified dto key value.</param>
	    /// <returns></returns>
	    public PlanillaMesDto ReadPlanillaMes(string dtoKey)
	    {
	        return this.PlanillaMesService.GetByKey(dtoKey);
	    }
	    
	    /// <summary>
	    /// Returns all planillameses count.
	    /// </summary>
	    /// <returns></returns>
	    public int PlanillaMesesCount()
	    {
	        return this.PlanillaMesService.Count();
	    }
	    
	    /// <summary>
	    /// Returns all planillameses count filtered by the specified filter expression.
	    /// </summary>
	    /// <param name="filterExpression">The filter expression.</param>
	    /// <returns></returns>
	    public int PlanillaMesesCountFiltered(string filterExpression)
	    {
	        return this.PlanillaMesService.Count(filterExpression);
	    }
	
	    /// <summary>
	    /// Adds a new planillames from the given dto object into the database.
	    /// </summary>
	    /// <param name="planillames">The dto object.</param>
	    /// <returns>The dto key of the newly created planillames.</returns>
	    public string CreatePlanillaMes(PlanillaMesDto planillames)
	    {
	        string key = this.PlanillaMesService.Add(planillames);
	        this.UnitOfWork.SaveChanges();
	        return key;
	    }
	
	    /// <summary>
	    /// Updates an existing planillames in the database from the given dto object.
	    /// </summary>
	    /// <param name="planillames">The dto object.</param>
	    public void UpdatePlanillaMes(PlanillaMesDto planillames)
	    {
	        this.PlanillaMesService.Update(planillames);
	        this.UnitOfWork.SaveChanges();
	    }
	
	    /// <summary>
	    /// Update planillameses in the database from the given dto object list.
	    /// </summary>
	    /// <param name="planillameses">The dto object list.</param>
	    public void UpdatePlanillaMeses(IEnumerable<PlanillaMesDto> planillameses)
	    {
	        if (planillameses == null)
	        {
	            return;
	        }
	
	        foreach (PlanillaMesDto planillames in planillameses)
	        {
	            if (planillames == null)
	            {
	                continue;
	            ...
	            this.UpdatePlanillaMes(planillames);
	        }
	    }
	
	    /// <summary>
	    /// Deletes planillames from the database by the given dto object.
	    /// </summary>
	    /// <param name="planillames">The dto object.</param>
	    public void DeletePlanillaMes(PlanillaMesDto planillames)
	    {
	        this.PlanillaMesService.Delete(planillames);
	        this.UnitOfWork.SaveChanges();		
	    }
	
	    /// <summary>
	    /// Delete planillameses from the database by the given dto object list.
	    /// </summary>
	    /// <param name="planillameses">The dto object list.</param>
	    public void DeletePlanillaMeses(IEnumerable<PlanillaMesDto> planillameses)
	    {
	        if (planillameses == null)
	        {
	            return;
	        ...
	        foreach (PlanillaMesDto planillames in planillameses)
	        {
	            ...
	            this.DeletePlanillaMes(planillames);
	        }
	    }
