namespace Intelligob.Reportes.Recaudaciones
{
    ...
    /// <summary>
    /// Summary description for NotificacionDeuda.
    /// </summary>
    public partial class NotificacionDeuda : Telerik.Reporting.Report
    {
        public NotificacionDeuda()
        {
            //
        ...
        private void textBox19_ItemDataBinding(object sender, EventArgs e)
        {
            Telerik.Reporting.Processing.TextBox txt = (Telerik.Reporting.Processing.TextBox)sender;
            Intelligob.Cliente.Depositos.TablasDep td = new Intelligob.Cliente.Depositos.TablasDep();
            txt.Value = td.TesoreroNombres;
        }
    }
}